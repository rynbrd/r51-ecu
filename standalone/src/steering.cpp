...
SteeringKeypad::SteeringKeypad(Faker::Clock* clock, Faker::GPIO* gpio) :
        last_change_(0), clock_(clock), frame_(STEERING_SWITCH_FRAME_ID, 0, STEERING_SWITCH_FRAME_LEN) {
